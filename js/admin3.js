...
$(function () {
    ...
    function getApiBase() {
        return isEn ? 'https://dfx-back.7jing.com/api_en.php' : 'https://dfx-back.7jing.com/api_260626.php';
    }
    ...
    // let apiBase = 'https://dfx-back.7jing.com/api_260626.php';
    // if(isEn){
    //     apiBase = 'https://dfx-back.7jing.com/api_en.php';
    // }
    ...
    function loadFolders() {
        $.getJSON(getApiBase() + '?type=folders' + authParams(), function (res) {
            if (res.code === 0) {
    ...
    function loadDocuments(folderId) {
        ...
        $.getJSON(getApiBase() + '?type=documents&folder_id=' + encodeURIComponent(folderId) + authParams(), function (res) {
        if (res.code === 0) {
            var folderName = getLocalizedText($('#folder-ct a[data-folder="' + folderId + '"]').data('name')) || '';
    ...
    function loadDocumentDetail(docId) {
        ...
        $.getJSON(getApiBase() + '?type=document_detail&doc_id=' + encodeURIComponent(docId) + authParams(), function (res) {
    ...
    function verifyDocumentPassword(docId, password, callback) {
        ...
        $.getJSON(getApiBase() + '?type=verify_document_password&doc_id=' + encodeURIComponent(docId) + '&doc_password=' + encodeURIComponent(password) + auth, function (res) {
    ...
    function renderFolders(list) {
        ...
        list.forEach(function (item) {
            ...
            var lockedContent = item.locked ? tips : '';
    ...
    $('#login').off('click').on('click', function () {
        ...
        $.post(getApiBase() + '?type=login', { username: username, password: password }, function (res) {
            if (res.code === 0) {
                loginUser = username;
                loginPass = password;
                loadFolders();
